  ...
  return (
    <body>
      <div className="bg-black-300 p-4">
        <h1 className="text-center"> POLÍTICA DE PRIVACIDADE - ATELIÊ DE COSTURA </h1>
        <p className="text-center"> Nossos Política de privacidade foi atualizada no dia 6/2/2025 </p>
        ...
        <p>
          ...
          sob as normas da Constituição Federal de 1988 (art. 5º, LXXIX;
          e o art. 22º, XXX – incluídos pela EC 115/2022), das normas de
        ...
        <p>
          Dessa forma, a (nome empresarial), doravante denominada simplesmente
          como “(nome empresarial simplificado)”, inscrita no CNPJ/MF sob o nº
          (nº do CNPJ), no papel de Controladora de Dados, obriga-se ao disposto
          na presente Política de Privacidade. Nosso site coleta e utiliza alguns
          dados pessoais seus, de forma a viabilizar a prestação de serviços e
          aprimorar a experiência de uso.
        </p>

        <ul>
          <li>1. Quais dados coletamos sobre você e para qual finalidade?
            <ul>
              <li>
              1.1. Dados pessoais fornecidos pelo titular
              Dado e finalidade Dado e finalidade Dado e finalidade Dado e
              finalidade
              </li>
              <li>
          ...
          <li>
            ...
            Como se coleta Como se coleta Como se coleta Como se coleta
          </li>
        </ul>
...
pela qual você autoriza a (nome empresarial simplificado) a tratar
seus dados.
</p>
...
transparência e boa-fé da (nome empresarial simplificado) para com seus
...
<p>
A (nome empresarial simplificado) assegura a seus usuários/clientes seus
direitos de titular previstos no artigo 18 da Lei Geral de Proteção de
Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo:
</p>

<p>
    Confirmar a existência de tratamento de dados, de maneira
    simplificada ou em formato claro e completo.  Acessar seus dados,
    podendo solicitá-los em uma cópia legível sob forma impressa
    ou por meio eletrônico, seguro e idôneo.  Corrigir seus dados,
    ...
    bloqueio ou eliminação.  Solicitar a portabilidade de seus dados,
    através de um relatório de dados cadastrais que a (nome empresarial
    simplificado) trata a seu respeito.  Eliminar seus dados tratados
    a partir de seu consentimento, exceto nos casos previstos em lei.
...
com a (nome empresarial simplificado) através dos seguintes meios
disponíveis:
</p>

<p>
     Meio de contato Meio de contato
</p>
...
<p>
Seus dados pessoais coletados pela (nome empresarial simplificado) serão
...
de Privacidade sejam atingidas, considerando os direitos dos titulares
dos dados e dos controladores.
</p>

<p>
De modo geral, seus dados serão mantidos enquanto a relação contratual
entre você e a (nome empresarial simplificado) perdurar. Findado o
período de armazenamento dos dados pessoais, estes serão excluídos
de nossas bases de dados ou anonimizados, ressalvadas as hipóteses
legalmente previstas no artigo 16 lei geral de proteção de dados,
a saber:
</p>
...
para o cumprimento de determinações legais, judiciais e administrativas
...
<p>
O armazenamento de dados coletados pela (nome empresarial simplificado)
reflete o nosso compromisso com a segurança e privacidade dos seus
dados. Empregamos medidas e soluções técnicas de proteção aptas
a garantir a confidencialidade, integridade e inviolabilidade dos
...
<p>
    Apenas pessoas autorizadas têm acesso a seus dados pessoais O
...
<p>
A (nome empresarial simplificado) se compromete a adotar as melhores
posturas para evitar incidentes de segurança. Contudo, é necessário
destacar que nenhuma página virtual é inteiramente segura e livre
de riscos. É possível que, apesar de todos os nossos protocolos de
...
sobre o ocorrido, em consonância com as disposições da Lei Geral de
Proteção de Dados.

7. Com quem seus dados podem ser compartilhados?

Tendo em vista a preservação de sua privacidade, a (nome empresarial
simplificado) não compartilhará seus dados pessoais com nenhum terceiro
não autorizado.

Seus dados poderão ser compartilhados com nossos parceiros comerciais:
(nome completo ou empresarial do parceiro comercial), inscrito no
CPF/CNPJ sob o nº (número do CPF Ou CNPJ do parceiro comercial).

Estes recebem seus dados apenas na medida do necessário para a
prestação dos serviços contratados e nossos contratos são orientados
pelas normas de proteção de dados do ordenamento jurídico brasileiro.

Todavia, nossos parceiros têm suas próprias Políticas de Privacidade,
que podem divergir desta. Recomendamos a leitura desses documentos,
que você pode acessar aqui:

Política de Privacidade do nosso parceiro: (link para a política de
privacidade do parceiro comercial).
...
II – Caso de movimentações societárias, como fusão, aquisição
e incorporação, de forma automática

III – Proteção dos direitos da (nome empresarial simplificado)
...
Nesse sentido, a (nome empresarial simplificado) se compromete a sempre
adotar eficientes padrões de segurança cibernética e de proteção
de dados, nos melhores esforços de garantir e cumprir as exigências
legislativas.
...
A (nome empresarial simplificado) faz uso de Cookies, que são arquivos
de texto enviados pela plataforma ao seu computador e que nele se
armazenam, que contém informações relacionadas à navegação do
site. Em suma, os Cookies são utilizados para aprimorar a experiência
de uso.
...
A (nome empresarial simplificado) utiliza os seguintes Cookies:
(descrição dos tipos de Cookies utilizados pelo site).
...
e como eles funcionam na nossa Política de Cookies, disponível neste
link (link para a Política de Cookies).
...
em nosso site e sempre lhe notificaremos acerca das mudanças ocorridas.
...
A (nome empresarial simplificado) prevê a responsabilidade dos agentes
que atuam nos processos de tratamento de dados, em conformidade com os
...
virtual inteiramente livre de riscos. Nesse sentido, a (nome empresarial
...
exceto se comprovada conduta culposa ou deliberada da (nome empresarial
simplificado).
...
A (nome empresarial simplificado) disponibiliza os seguintes meios para
que você possa entrar em contato conosco para exercer seus direitos
de titular: (meios de contato).
